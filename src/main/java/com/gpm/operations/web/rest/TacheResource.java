...
/**
 * REST controller for managing {@link com.gpm.operations.domain.Tache}.
 */
@RestController
@RequestMapping("/api")
public class TacheResource {
    ...
    private static final String ENTITY_NAME = "operationsServiceTache";
    ...
    public ResponseEntity<List<TacheDTO>> getAllTaches(
        ...
        Page<TacheDTO> page;
        if (eagerload) {
            page = tacheService.findAllWithEagerRelationships(pageable);
        } else {
