...
import com.gpm.operations.service.ArticleMissionService;
...
/**
 * REST controller for managing {@link com.gpm.operations.domain.ArticleMission}.
 */
@RestController
@RequestMapping("/api")
public class ArticleMissionResource {
    ...
    private static final String ENTITY_NAME = "operationsServiceArticleMission";
    ...
    public ArticleMissionResource(ArticleMissionService articleMissionService, ArticleMissionRepository articleMissionRepository) {
    ...
    public ResponseEntity<ArticleMissionDTO> createArticleMission(@Valid @RequestBody ArticleMissionDTO articleMissionDTO)
        ...
        return ResponseEntity
            .created(new URI("/api/article-missions/" + result.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, result.getId().toString()))
            .body(result);
    }

    /**
     * {@code PUT  /article-missions/:id} : Updates an existing articleMission.
     *
     * @param id the id of the articleMissionDTO to save.
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/article-missions/{id}")
    public ResponseEntity<ArticleMissionDTO> updateArticleMission(
        @PathVariable(value = "id", required = false) final Long id,
        @Valid @RequestBody ArticleMissionDTO articleMissionDTO
    ) throws URISyntaxException {
        log.debug("REST request to update ArticleMission : {}, {}", id, articleMissionDTO);
        if (articleMissionDTO.getId() == null) {
            throw new BadRequestAlertException("Invalid id", ENTITY_NAME, "idnull");
        }
        if (!Objects.equals(id, articleMissionDTO.getId())) {
            throw new BadRequestAlertException("Invalid ID", ENTITY_NAME, "idinvalid");
        }

        if (!articleMissionRepository.existsById(id)) {
            throw new BadRequestAlertException("Entity not found", ENTITY_NAME, "idnotfound");
        }

        ArticleMissionDTO result = articleMissionService.update(articleMissionDTO);
        return ResponseEntity
            .ok()
    ...
    /**
     * {@code PATCH  /article-missions/:id} : Partial updates given fields of an existing articleMission, field will ignore if it is null
     *
     * @param id the id of the articleMissionDTO to save.
     * @param articleMissionDTO the articleMissionDTO to update.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated articleMissionDTO,
     * or with status {@code 400 (Bad Request)} if the articleMissionDTO is not valid,
     * or with status {@code 404 (Not Found)} if the articleMissionDTO is not found,
     * or with status {@code 500 (Internal Server Error)} if the articleMissionDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/article-missions/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<ArticleMissionDTO> partialUpdateArticleMission(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody ArticleMissionDTO articleMissionDTO
    ) throws URISyntaxException {
        log.debug("REST request to partial update ArticleMission partially : {}, {}", id, articleMissionDTO);
        if (articleMissionDTO.getId() == null) {
            throw new BadRequestAlertException("Invalid id", ENTITY_NAME, "idnull");
        }
        if (!Objects.equals(id, articleMissionDTO.getId())) {
        ...
        Optional<ArticleMissionDTO> result = articleMissionService.partialUpdate(articleMissionDTO);

        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, articleMissionDTO.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<ArticleMissionDTO>> getAllArticleMissions(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
